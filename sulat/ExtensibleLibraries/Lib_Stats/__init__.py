...
File: sulat/ExtensibleLibraries/Lib_Stats/__init__.py
...
ExLib_Stats = ExtensibleLibrary(__file__, __package__, (lambda x: issubclass(x, ResamplerBase) if inspect.isclass(x) else False,))
