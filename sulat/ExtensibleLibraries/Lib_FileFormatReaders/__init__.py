...
File: sulat/ExtensibleLibraries/Lib_FileFormatReaders/__init__.py
...
from ..Resources import ExtensibleLibrary

ExLib_FileFormatReaders = ExtensibleLibrary(__file__, __package__)
